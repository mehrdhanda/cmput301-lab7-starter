...
public class MainActivityTest {
    ...
    //  TEST CASES FOR ShowActivity

    // Test 1: Check if the activity correctly switched
    @Test
    ...
    public void testCityNameConsistent() {
        ...
        // Check ShowActivity displays the correct city name
        onView(withId(R.id.tvCityName)).check(matches(withText("Berlin")));
    }
    ...
    public void testBackButton() {
        // Add a city
        onView(withId(R.id.button_add)).perform(click());
        onView(withId(R.id.editText_name)).perform(ViewActions.typeText("Sydney"));
        onView(withId(R.id.button_confirm)).perform(click());
        ...
        // Check that the city list is visible
